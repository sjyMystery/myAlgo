...
class RSIEventWindow(indicator.EventWindow):
    ...
    def onNewValue(self, dateTime, value):
        ...
        # Formula from http://stockcharts.com/school/doku.php?id=chart_school:indicator_indicators:relative_strength_index_rsi
...
class RSI(indicator.EventBasedFilter):
    """Relative Strength Index filter as described in http://stockcharts.com/school/doku.php?id=chart_school:indicator_indicators:relative_strength_index_rsi.
