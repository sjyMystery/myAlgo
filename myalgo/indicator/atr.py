...
# Formula from http://stockcharts.com/school/doku.php?id=chart_school:indicator_indicators:average_true_range_atr.
class ATREventWindow(indicator.EventWindow):
...
class ATR(indicator.EventBasedFilter):
    """Average True Range filter as described in http://stockcharts.com/school/doku.php?id=chart_school:indicator_indicators:average_true_range_atr

    :param barDataSeries: The BarDataSeries instance being filtered.
    :type barDataSeries: :class:`myalgo.dataseries.bards.BarDataSeries`.
